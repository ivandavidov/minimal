  ...
  render() {
    return (
      <div id="item3" style={{display: "none"}}>
        ...
        <div className="row">
          <div className="twelve columns">
            You can follow Minimal Linux Live on <a href="http://facebook.com/MinimalLinuxLive" target="_blank" rel="noopener noreferrer">Facebook</a>. If you'd like to contact me, my e-mail is: <strong>davidov [dot] i (at) gmail &amp123;dot&amp125; com</strong>. Let me know if you find this project useful. Thanks! :)
          </div>
        </div>
        <div style={{fontSize: 10 + "%"}}>&nbsp;</div>
        <div className="row">
