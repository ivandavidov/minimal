...
import {logSwap} from '../js/main.js';
          ...
          <div className="twelve columns">
            ...
            <div id="text4" style={{display: "none"}}>
              <ul>
                ...
                <li>
                  In addition to the above changes, if you <a href="#download" onClick={() => {loadTab(this.href); return false;}}>download</a> the current stable build scripts, you will notice a folder named <strong>experimental</strong>. This folder contains some interesting scripts which produce ISO based on Linux kernel and <a href="http://landley.net/toybox" target="_blank" rel="noopener noreferrer">ToyBox</a> instead of Busybox. Please have in mind that this is work in progress and these scripts may not work on your host OS.
                </li>
              </ul>
            </div>
            <div style={{fontSize: 10 + "%"}}>&nbsp;</div>
