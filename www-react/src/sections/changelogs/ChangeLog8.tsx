    ...
    return (
      <div>
        <div id="show8" style={{display: "none"}}>
          <strong>04-Nov-2019</strong>&nbsp;
          <a href="#changes" onClick={() => {logSwap(8, true); return false;}}>show</a>
        </div>
        <div id="hide8" style={{display: "block"}}>
          <strong>04-Nov-2019</strong>&nbsp;
          <a href="#changes" onClick={() => {logSwap(8, false); return false;}}>hide</a>
        </div>
        <div id="text8" style={{display: "block"}}>
          <div style={{fontSize: 10 + "%"}}>&nbsp;</div>
          <ul>
            <li>
              <strong>Updated software base</strong> - Minimal Linux Live (MLL) is based on Linux kernel 5.3.8, GNU C library 2.30 and Busybox 1.31.1. The generated ISO image file is 10MB (x86_64) and requires 256MB RAM in order to run properly.
            </li>
            <li>
            ...
            <li>
                <strong>Other overlay bundle changes</strong> - vitetris (tetris game), java bundle (Oracle JDK) has been deprecated and removed, util_linux no longer requires root privileges to build.
            </li>
            <li>
